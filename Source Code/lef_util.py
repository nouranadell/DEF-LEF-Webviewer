...
class Macro(Statement):
    ...
    def parse_next(self, data):
        ...
        if data[0] == "CLASS":
            ...
            file.write("Size " + str(width) + " " + str(height) + '\n')
...
class LayerDef:
    ...
    def add_rect(self, data):
        ...
        y1 = float(data[4])
        #points = [(x0, y0), (x1, y1)]
        points = str(x0) + " " + str(y0) + " " + str(x1) + " " + str(y1)
        rect = Rect(points)
...
class Rect:
    ...
    def __init__(self, points):
        self.type = "RECT"
        self.points = points
        file.write("RECT " + str(self.points) + '\n')
